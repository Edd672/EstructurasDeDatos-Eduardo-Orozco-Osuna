...
public class Menu {
    ...
    private String ERROR_TIPO_NUMERICO = "El valor ingresado no posee un formato numérico. Intente de nuevo: ";
    private String ERROR_FUERA_RANGO = "Opción no disponible. Intente de nuevo: ";
